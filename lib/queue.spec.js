      ...
      it('pops a job from redis', async () => {
        ...
        assert.deepStrictEqual(snapshot, {
          ...
          queue: {
            ...
            queued: [
              'https://example.com/product_pop1',
              'https://example.com/product_pop2',
            ],
            processing: [],
          }
        })
        ...
        assert.deepStrictEqual(outputProcessingJobs, {
          'https://example.com/product_pop1': jobData1
        })
  ...
  describe('deregister', () => {
    ...
    it('removes the job from the \'processing\' set and adds the job to the \'done\' set', async () => {
      ...
      assert.deepStrictEqual(outputDoneJobs, {
        'https://example.com/deregister_move_job': JSON.stringify(jobData)
      })
