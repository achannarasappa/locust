...
describe('queue', () => {
  ...
  describe('register', () => {
    ...
    context('when it is the first run', () => {
      ...
      it('creates a new job in redis', async () => {
        ...
        const { snapshot, config } = await register(redis, createJob)
      ...
      it('pops a job from redis', async () => {
        ...
        assert.deepStrictEqual(snapshot, {
          ...
          queue: {
            ...
            queued: [
              'https://amazon.com/product_pop1',
              'https://amazon.com/product_pop2',
            ],
            processing: [],
          }
        })
  ...
  describe('getSnapshot', () => {
    ...
    it('gets a snapshot of queues and state from redis');
  
  });

  describe('remove', () => {
  
    it('removes all objects from redis related to the queue');
